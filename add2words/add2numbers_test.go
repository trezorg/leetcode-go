...
func TestListToInt(t *testing.T) {
	...
	list2 := newList(lst2)
	list3 := newList(lst3)
	assert.Equal(t, 342, list1.toInt())
	assert.Equal(t, 465, list2.toInt())
...
func TestAdd2Numbers1(t *testing.T) {
	...
	assert.Equal(t, 342, res1.toInt())
	assert.Equal(t, []int{5, 6, 4}, res2.toList())
	assert.Equal(t, 465, res2.toInt())
	assert.Equal(t, []int{7, 0, 8}, res3.toList())
...
func TestAdd2Numbers2(t *testing.T) {
	...
	assert.Equal(t, []int{7, 0, 8, 5}, res.toList())
	assert.Equal(t, 5807, res.toInt())
}
...
func TestAdd2Numbers3(t *testing.T) {
	...
	list2 := newList(lst2)
	res := addTwoNumbers(list1, list2)
	assert.Equal(t, []int{0, 1}, res.toList())
	...
	list2 = newList(lst2)
	res = addTwoNumbers(list1, list2)
	assert.Equal(t, []int{4, 5, 1}, res.toList())
